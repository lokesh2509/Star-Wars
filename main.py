...
window.title("Star Wars Game by Lokesh Vyas")
...
class ST_CLASS_1(turtle.Turtle):
    def __init__(self):
...
for _ in range(5):
    ...
    chattan.fd(distance)
    chattan.setheading(ST_CLASS_2(player, chattan))
...
window.mainloop()
# This Game is build by Lokesh Vyas
